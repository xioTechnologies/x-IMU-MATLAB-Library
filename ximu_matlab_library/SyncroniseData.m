function xIMUdata = SyncroniseData(varargin)
    ...
    for i = 1:numel(xIMUdataObjs)
        try h = xIMUdataObjs{i}.DateTimeData; h.StartTime = -StartEvent(i); catch e, end
        ...
        try h = xIMUdataObjs{i}.RawAnalogueInputData; h.StartTime = -StartEvent(i); catch e, end
        try h = xIMUdataObjs{i}.CalAnalogueInputData; h.StartTime = -StartEvent(i); catch e, end        
        try h = xIMUdataObjs{i}.RawADXL345busData; h.StartTime = -StartEvent(i); catch e, end
        try h = xIMUdataObjs{i}.CalADXL345busData; h.StartTime = -StartEvent(i); catch e, end
    end
    ...
    for i = 2:numel(xIMUdataObjs)
        try h = xIMUdataObjs{i}.DateTimeData; h.SampleRate = scalers(i)*h.SampleRate; h.StartTime = StartEvent(i)/scalers(i); catch e, end
        ...
        try h = xIMUdataObjs{i}.RawAnalogueInputData; h.SampleRate = scalers(i)*h.SampleRate; h.StartTime = StartEvent(i)/scalers(i); catch e, end
        try h = xIMUdataObjs{i}.CalAnalogueInputData; h.SampleRate = scalers(i)*h.SampleRate; h.StartTime = StartEvent(i)/scalers(i); catch e, end
        try h = xIMUdataObjs{i}.RawADXL345busData; h.SampleRate = scalers(i)*h.SampleRate; h.StartTime = StartEvent(i)/scalers(i); catch e, end
        try h = xIMUdataObjs{i}.CalADXL345busData; h.SampleRate = scalers(i)*h.SampleRate; h.StartTime = StartEvent(i)/scalers(i); catch e, end        
    end
end
